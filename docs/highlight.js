...
(function () {
	...
	document.addEventListener('DOMContentLoaded', function () {
		...
		if (exampleSelect && playgroundCode && playgroundTextarea) {
			var EXAMPLES = {};
			var EXAMPLE_KEYS = ['hello-world', 'projectile', 'combat', 'destructuring', 'methods-and-statics', 'multiline-strings',  'calculator', 'fibonacci', 'fizzbuzz', 'arrays', 'ranges-and-chars', 'range-match'];
